...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'ens.jobeet.admin.category' => 'getEns_Jobeet_Admin_CategoryService',
            'ens.jobeet.admin.job' => 'getEns_Jobeet_Admin_JobService',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'jobeet', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array(($this->targetDirs[3].'\\src\\Ens\\JobeetBundle\\Resources\\config\\doctrine') => 'Ens\\JobeetBundle\\Entity'));
        $a->setGlobalBasename('mapping');

        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver($a, 'Ens\\JobeetBundle\\Entity');

        $c = new \Doctrine\ORM\Configuration();
        $c->setEntityNamespaces(array('EnsJobeetBundle' => 'Ens\\JobeetBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_ee56703464885424d1333c13c5b764974c39e2b287aee01feea393c2c96177bf');
    ...
    protected function getSonata_Admin_PoolService()
    {
        ...
        $instance->setAdminServiceIds(array(0 => 'ens.jobeet.admin.category', 1 => 'ens.jobeet.admin.job'));
        $instance->setAdminGroups(array('jobeet' => array('label' => 'jobeet', 'label_catalogue' => 'SonataAdminBundle', 'icon' => '<i class="fa fa-folder"></i>', 'roles' => array(), 'items' => array(0 => 'ens.jobeet.admin.category', 1 => 'ens.jobeet.admin.job'))));
        $instance->setAdminClasses(array('Ens\\JobeetBundle\\Entity\\Category' => array(0 => 'ens.jobeet.admin.category'), 'Ens\\JobeetBundle\\Entity\\Job' => array(0 => 'ens.jobeet.admin.job')));
    ...
    {
        return $this->services['sonata.admin.route_loader'] = new \Sonata\AdminBundle\Route\AdminPoolLoader($this->get('sonata.admin.pool'), array(0 => 'ens.jobeet.admin.category', 1 => 'ens.jobeet.admin.job'), $this);
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Knp\Menu\Twig\MenuExtension(new \Knp\Menu\Twig\Helper($this->get('knp_menu.renderer_provider'), $this->get('knp_menu.menu_provider'), $a), $this->get('knp_menu.matcher'), $a));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\Ens\\JobeetBundle/Resources/views'), 'EnsJobeet');
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addYamlMappings(array(0 => ($this->targetDirs[3].'\\src\\Ens\\JobeetBundle\\Resources\\config\\validation.yml')));
